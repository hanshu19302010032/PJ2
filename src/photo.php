...
<div id="wrapper">
        ...
        <ul>
            ...
            <li><a>My Account</a>
                <ul>
                    ...
                    <li class="mark"><a href="photo.php">
    ...
    <main>
        ...
        if (mysqli_connect_error()) {
            ...
            $sql = "select count(*) from userimage";
            $result = $db->query($sql);
            $sj = $result->fetch_row();
            $total = $sj[0];
//            echo $total;
//            $limit = min($total, 5);
            ...
            $sqlshow = "select * from userimage " . $page->limit;
        ...
        ";
            ...
            while ($row = $resultall->fetch_row()) {
                echo "<tr>
                        <td>{$row[0]}</td>
                        <td>
                        <img src=\"getimage.php?id=" . $row[0] . "\"  width=\"200\" height=\"100\"></td>
                        <td>{$row[5]}</td>
                        <td>{$row[6]}</td>
                        <td>{$row[7]}</td>
                        <td>{$row[8]}</td>
                        ...
                        <td>{$row[10]}</td>
                        <td>
                            <button id='modify" . $row[0] . "' onclick='modify(id)'>modify</button>
                            <br>
